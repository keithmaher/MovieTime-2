...
public final class ToJsonString {
	 ...
	 * fields with their values. This method does not process superclass properties.
	 * <p/>
	 * 
	 * @param clazz
	...
	/**
	 * Uses Reflection to associate the names of all fields with their values. This
	 * method does not process superclass properties.
	 * <p/>
	 * 
	 * @param clazz
	 *            the class whose fields to process
	...
	/**
	 * Associates the specified value with the specified key. If the key was already
	 * associated with a value, the old value is replaced by the specified value. If
	 * {@code value} is {@code null}, the string {@code "null"} is used.
	 * <p/>
	 * 
	 * @param key
	 *            the key
